                        ...
                        child: Column(
                          ...
                          children: [
                            Text.rich(TextSpan(children: [
                              TextSpan(
                                text: context.localizations!.customize,
                                style: TextStyle(
                              ...
                              TextSpan(
                                text:
                                    " ${context.localizations!.your} ${widget.data.category} ${context.localizations!.to_your_tastes_ultimate_experience}",
                                style: TextStyle(
                            ...
                            Column(
                              ...
                              children: [
                                Padding(
                                  ...
                                  child: Text(context.localizations!.spicy,
                  ...
                  child: Column(
                    children: [
                      Align(
                        ...
                        child: Text(
                          context.localizations!.toppings,
                          style: TextStyle(
                            fontSize: 18.sp,
                            color: AppColors.lightoffblack,
                ...
                child: Column(
                  children: [
                    Align(
                      alignment: Alignment.centerLeft,
                      child: Text(
                        context.localizations!.side_options,
                        style: TextStyle(
                          fontSize: 18.sp,
                          color: AppColors.lightoffblack,
                          fontWeight: FontWeight.w600,
                      ...
                      child: Container(
                        ...
                        child: Padding(
                          ...
                          child: Center(
                            child: FittedBox(
                              child: Text(
                                context.localizations!.add_to_cart,
                                style: GoogleFonts.inter(
                                    fontSize: 18.sp,
                                    fontWeight: FontWeight.w600,
                                    color: Colors.white),
